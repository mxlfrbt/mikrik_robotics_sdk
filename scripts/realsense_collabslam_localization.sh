...
ros2 launch univloc_tracker tracker_mikrik_loc.launch.py use_odom:=true &
pid3=$!

ros2 launch univloc_server server_mikrik.launch.py rviz:=true load_map_path:=/tmp/pointcloud_map_new.msg server_mode:=localization &
pid4=$!
